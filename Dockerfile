...
# Nextcloud depends
RUN apk add php7-ctype php7-curl php7-dom php7-fileinfo php7-gd php7-iconv php7-json php7-mbstring php7-openssl php7-session php7-simplexml php7-xml php7-xmlreader php7-xmlwriter php7-zip php7-zlib php7-posix libzip
# Extra depends
